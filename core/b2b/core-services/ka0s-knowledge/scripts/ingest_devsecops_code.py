...
logger = logging.getLogger("ka0s.ingest_devsecops_code")
...
def chunk_text(text: str, chunk_chars: int, overlap_chars: int = 0) -> List[str]:
    ...
    # DevSecOps Code Splitting: Using Python AST splitter as default for code
    # This prevents splitting functions/classes in half
    try:
        ...
        logger.warning(f"Failed to use Language.PYTHON splitter, falling back: {e}")
