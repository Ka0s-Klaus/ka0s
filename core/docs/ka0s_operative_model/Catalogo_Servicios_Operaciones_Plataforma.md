...
Este documento define el modelo de servicios gestionados de operaciones para plataformas on‑prem y cloud (pública/privada), estableciendo alcance, exclusiones, SLAs/SLOs, responsabilidades (RACI), seguridad y gobierno. Se contemplan horarios de atención **24x7** y **8x5** y el uso de **iTop** como herramienta ITSM.
...
**Fuentes de evidencia:** herramientas de monitorización, iTop (ITSM), backup, FinOps.
...
**Prerequisitos del cliente:** accesos, contactos, inventario, cuentas cloud, tagging, integración con iTop y herramientas de monitorización/backup.

**Suposiciones:** conectividad estable, licencias vigentes, colaboración de terceros.
...
* **KPIs y CSFs:** SLA, calidad de cambios, postura de seguridad, costes cloud vs presupuesto, disponibilidad por servicio.
