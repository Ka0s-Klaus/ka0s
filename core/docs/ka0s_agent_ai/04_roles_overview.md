...
1. [Producto y Diseño](#4-producto-y-diseño)
1. [Ciberseguridad](#5-ciberseguridad)
1. [Reglas Transversales](#6-reglas-transversales)
...
### 4.3 Technical Program Manager (TPM)
...
### 5.2 Penetration Tester (Pentester)
...
*Documento generado como referencia de roles y estándares para equipos de tecnología. Versión 1.0.*