...
DB_HOST = os.getenv("POSTGRES_HOST", os.getenv("PG_HOST", "localhost"))
DB_PORT = os.getenv("POSTGRES_PORT", os.getenv("PG_PORT", "5433"))
DB_USER = os.getenv("POSTGRES_USER", os.getenv("PG_USER", "ka0s_ai"))
DB_PASS = os.getenv("POSTGRES_PASSWORD", os.getenv("PG_PASSWORD", "change_me_in_production_vector_db_123!"))
DB_NAME = os.getenv("POSTGRES_DB", os.getenv("PG_DB", "ka0s_memory"))
