...
- **Generated at**: Tue Feb 10 18:08:08 UTC 2026
- **Commit**: 978ce07a87e47e6d43be0965280fe94ec54181fa
- **Date**: Tue Feb 10 18:08:08 UTC 2026

## Trivy Configuration Check (Best Practices & Security)
### Scanning: core/b2b/core-services/soc
```
2026-02-10T18:08:09Z	INFO	[misconfig] Misconfiguration scanning is enabled
2026-02-10T18:08:09Z	INFO	[checks-client] Need to update the checks bundle
2026-02-10T18:08:09Z	INFO	[checks-client] Downloading the checks bundle...
235.65 KiB / 235.65 KiB [--------------------------------------------------------->] 100.00% ? p/s ?235.65 KiB / 235.65 KiB [-----------------------------------------------] 100.00% 1.39 MiB p/s 400ms2026-02-10T18:08:17Z	INFO	Detected config files	num=11
...
See https://avd.aquasec.com/misconfig/ksv-0014
────────────────────────────────────────
 05-dashboard.yaml:19-62
────────────────────────────────────────
  19 ┌         - name: wazuh-dashboard
  20 │           image: wazuh/wazuh-dashboard:4.14.2
  21 │           resources:
  22 │             requests:
  23 │               memory: "512Mi"
  24 │               cpu: "250m"
...
See https://avd.aquasec.com/misconfig/ksv-0014
────────────────────────────────────────
 06-agent-daemonset.yaml:95-131
────────────────────────────────────────
  95 ┌         - name: suricata
  96 │           image: jasonish/suricata:latest
  97 │           command: ["sh", "-c"]
  98 │           args:
  99 │             - |
 100 │               IFACE=$(cat /etc/suricata-shared/interface)
 101 │               echo "Starting Suricata on interface $IFACE..."
 102 │               if [ ! -f /etc/suricata-shared/suricata.yaml ]; then
 103 └                 echo "Error: Configuration file not found!"
 ...   
────────────────────────────────────────
...
See https://avd.aquasec.com/misconfig/ksv-0014
────────────────────────────────────────
 06-agent-daemonset.yaml:61-92
────────────────────────────────────────
  61 ┌         - name: wazuh-agent
  62 │           image: wazuh/wazuh-agent:4.14.2
  63 │           imagePullPolicy: Always
  64 │           command: ["/bin/bash", "-c"]
  65 │           args:
  66 │             - |
  67 │               echo "Injecting ossec.conf..."
  68 │               cp /tmp/wazuh-config/ossec.conf /var/ossec/etc/ossec.conf
  69 └               echo "Starting Wazuh Agent..."
  ..   
────────────────────────────────────────
...
See https://avd.aquasec.com/misconfig/ksv-0118
────────────────────────────────────────
 06-agent-daemonset.yaml:16-145
────────────────────────────────────────
  16 ┌     spec:
  17 │       hostNetwork: true
