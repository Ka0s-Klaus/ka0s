...
**Contexto detectado**
- Issue: #4459 (https://github.com/Ka0s-Klaus/ka0s/issues/4459)
- Título: [INCIDENT]: Fallo en workflow Ka0s Autom add audit -> MongoDB
- Categoría: incident
- Labels: automated, itop-incident, triage
- Evidencia/URL detectada: https://github.com/Ka0s-Klaus/ka0s/actions/runs/22763615224
