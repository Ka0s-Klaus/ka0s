...
**Contexto detectado**
- Issue: #4387 (https://github.com/Ka0s-Klaus/ka0s/issues/4387)
- Título: [INCIDENT] Linux: Load average is too high (zabbix-server)
- Categoría: incident
...
- Identificar el causante del pico: procesos (`top`), pods (`kubectl top`), y trabajos batch/cron recientes.
...
- Revisar capacity planning y límites/requests para prevenir saturación por picos recurrentes.
