...
**Contexto detectado**
- Issue: #4447 (https://github.com/Ka0s-Klaus/ka0s/issues/4447)
- Título: [INCIDENT]: Fallo en workflow Ka0s GitHub → iTop Sync
- Categoría: incident
- Labels: automated, itop-incident, triage
- Evidencia/URL detectada: https://github.com/Ka0s-Klaus/ka0s/actions/runs/22762505278
