...
**Contexto detectado**
- Issue: #4440 (https://github.com/Ka0s-Klaus/ka0s/issues/4440)
- Título: [INCIDENT] Service zabbix-web in zabbix has no endpoints (zabbix-server)
- Categoría: incident
...
- Validar Service/Endpoints: selector vs labels de pods, readiness, y endpoints asociados.
...
- Añadir checks preventivos: alertas por `Endpoints=0` y validación de selectors en despliegues.
