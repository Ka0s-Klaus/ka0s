...
**Contexto detectado**
- Issue: #4457 (https://github.com/Ka0s-Klaus/ka0s/issues/4457)
- Título: [INCIDENT]: Fallo en workflow Ka0s Audit Failed Pods -> iTop
- Categoría: incident
- Labels: automated, itop-incident, triage
- Evidencia/URL detectada: https://github.com/Ka0s-Klaus/ka0s/actions/runs/22763474390
