...
**Contexto detectado**
- Issue: #4426 (https://github.com/Ka0s-Klaus/ka0s/issues/4426)
- Título: [INCIDENT]: Fallo en workflow Ka0s Docs Auto-Update -> Index
- Categoría: incident
- Labels: automated, itop-incident, triage
- Evidencia/URL detectada: https://github.com/Ka0s-Klaus/ka0s/actions/runs/22736688813
