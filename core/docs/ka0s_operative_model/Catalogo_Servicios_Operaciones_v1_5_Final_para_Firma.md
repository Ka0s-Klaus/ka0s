...
- SLA/SLO definitivos por servicio, con ventanas de mantenimiento y excepciones claramente indicadas.
- Checklists de aceptación (“go/no-go”) por servicio, listos para firma.
- Paquete de importación iTop (CSV) para categorías, estados y catálogo inicial de SRs.
