...
**Contexto detectado**
- Issue: #4425 (https://github.com/Ka0s-Klaus/ka0s/issues/4425)
- Título: [INCIDENT] High number of open issues on Ka0s-Klaus/ka0s (52) (GitHub - ka0s)
- Categoría: incident
...
- Reducir backlog: agrupar duplicados, cerrar ruido, y etiquetar por prioridad/SLA (p. ej. P0/P1/P2).
...
- Establecer política de higiene: auto-triage, límite de creación automática y reportes periódicos (lead time/backlog).
