...
**Contexto detectado**
- Issue: #4297 (https://github.com/Ka0s-Klaus/ka0s/issues/4297)
- Título: [INCIDENT]: Fallo en workflow Ka0s -> Deploy Docs Portal (Debug)
- Categoría: incident
- Labels: automated, incident
- Evidencia/URL detectada: https://github.com/Ka0s-Klaus/ka0s/actions/runs/22623998539
