...
**Contexto detectado**
- Issue: #4298 (https://github.com/Ka0s-Klaus/ka0s/issues/4298)
- Título: [INCIDENT]: Fallo en workflow Ka0s CD Core Services Deploy -> K8s
- Categoría: incident
- Labels: automated, itop-incident, triage
- Evidencia/URL detectada: https://github.com/Ka0s-Klaus/ka0s/actions/runs/22624262467
