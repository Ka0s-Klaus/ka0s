...
Date: Tue Feb  3 07:48:33 UTC 2026
...
actions-runner-system/swarm-runners-scaleset-hkss5-runner-4hp56
calico-system/calico-node-g7m88
calico-system/calico-node-hnmlv
calico-system/calico-node-jvntn
calico-system/calico-node-rf4ft
...
itop/itop-6fc6846b99-r82bv
itop/mysql-5778cc7679-qh2jk
```
...
│ local-path-storage    │ Deployment/local-path-provisioner             │   2    │   9    │         │ 3       │    │    │
│ itop                  │ Deployment/itop                               │        │   18   │         │ 5       │    │ 2  │
...
│ actions-runner-system │ Pod/swarm-runners-scaleset-hkss5-runner-4hp56 │        │   36   │         │ 3       │    │    │
└───────────────────────┴───────────────────────────────────────────────┴────────┴────────┴─────────┴─────────┴────┴────┘
...
│ kube-system │ DaemonSet/kube-proxy                   │   2   │   12    │         │ 4       │    │    │
...
| Pod Security (Root User) | 67 | 64 | 4% |
...
- kube-system/kube-proxy-zwsjt
- kube-system/kube-scheduler-k8-manager
- local-path-storage/local-path-provisioner-7d6dddf9dd-htfhp
- metallb-system/speaker-92zh5
...
- monitoring/cadvisor-m8ggh
- monitoring/cadvisor-szbzt
- monitoring/grafana-85c58bb87f-5s6mq
- monitoring/loki-0
- monitoring/node-exporter-4j2n7
- monitoring/node-exporter-cnch2
- monitoring/node-exporter-fk6wz
- monitoring/node-exporter-zs9ll
- monitoring/prometheus-deployment-5ff89c466c-lsxl2
- monitoring/promtail-62s7t
- monitoring/promtail-64vgx
- monitoring/promtail-qml9t
- monitoring/promtail-wcxsz
- n8n/n8n-9d98769d8-mqgjn
- n8n/postgres-84c7bcf4d5-tdz66
- planka/planka-5cbbfc9bb7-7cxcn
- planka/planka-5cbbfc9bb7-7cxcn
- planka/planka-db-b96db4468-zmxn7
- tigera-operator/tigera-operator-7b9dcd4cd7-k6bx2
...
- zabbix/zabbix-agent-ksjkb
- zabbix/zabbix-agent-ksx2w
- zabbix/zabbix-server-6575fb47cc-8p7rt
