...
**Contexto detectado**
- Issue: #4458 (https://github.com/Ka0s-Klaus/ka0s/issues/4458)
- Título: [INCIDENT]: Fallo en workflow Ka0s Audit Cluster Status
- Categoría: incident
- Labels: automated, itop-incident, triage
- Evidencia/URL detectada: https://github.com/Ka0s-Klaus/ka0s/actions/runs/22763960620
